...
Egm2008GeoidGrid::Egm2008GeoidGrid( void )
{
   ...
   int     length   =    0;
    ...
    const char* fileName = [[dataBundle stringByAppendingPathComponent:@"Und_min2.5x2.5_egm2008_WGS84_TideFree_reformatted"]
...
Egm2008GeoidGrid::Egm2008GeoidGrid( const std::string  &gridFname )
{
   ...
   // Get reformatted geoid height grid's file name .....
    ...
    const char* fileName = [[dataBundle stringByAppendingPathComponent:@"libegm2008grd.so"]
                              fileSystemRepresentation];
    //
    _gridFname = fileName;
