...
/*  Open the File READONLY, or Return Error Condition:                        */
    ...
    const char* fileName = [[dataBundle stringByAppendingPathComponent:@"egm96.grd"]
                              fileSystemRepresentation];
    //

  if ( ( geoid_height_file = fopen( fileName, "rb" ) ) == NULL )
  {
    char message[256] = "";
...
/*  Open the File READONLY, or Return Error Condition:                        */
    ...
    const char* fileName = [[dataBundle stringByAppendingPathComponent:@"egm84.grd"]
                            fileSystemRepresentation];
    //
...
/*  Open the File READONLY, or Return Error Condition:                        */
    ...
    const char* fileName = [[dataBundle stringByAppendingPathComponent:@"wwgrid.bin"]
                            fileSystemRepresentation];
    //
