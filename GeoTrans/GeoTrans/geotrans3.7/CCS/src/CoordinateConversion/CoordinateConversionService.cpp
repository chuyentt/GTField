 ...
 */
  ...
  long num = sourceCoordinatesCollection.size();
  long numTargetCoordinates = targetCoordinatesCollection.size();
  long numTargetAccuracies = targetAccuracyCollection.size();
  ...
  {
    for(long i = num; i < numTargetCoordinates; i++)
    {
  ...
  {
    for(long i = num; i < numTargetAccuracies; i++)
    {
