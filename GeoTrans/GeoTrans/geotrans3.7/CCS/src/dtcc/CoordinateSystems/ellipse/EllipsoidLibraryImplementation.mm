 ...
 */
  ...
  strcat( FileName, "ellips.dat" );
    ...
    NSString *ellipsPath = [dataBundle stringByAppendingPathComponent:@"ellips.dat"];
    const char* ellipsFile = [ellipsPath fileSystemRepresentation];
    //
    
  if( ( fp = fopen( ellipsFile, "w" ) ) == NULL )
  { /* fatal error */
 ...
 */
  ...
  /*  Open the File READONLY, or Return Error Condition:                        */
    ...
    const char* ellipsFile = [[dataBundle stringByAppendingPathComponent:@"ellips.dat"]
                              fileSystemRepresentation];
    //
  if( ( fp = fopen( ellipsFile, "r" ) ) == NULL )
  {
