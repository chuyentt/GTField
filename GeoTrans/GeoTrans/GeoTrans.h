...
//! Project version number for GeoTrans.
FOUNDATION_EXPORT double GeoTransVersionNumber;

//! Project version string for GeoTrans.
FOUNDATION_EXPORT const unsigned char GeoTransVersionString[];
